            ...
            searchButton.click(function(event) {
                ...
                if (keywords.length < 3) {
                    if (settings.useAlert) {
                        window.alert(info.translations[settings.language].errorTooShort);
                    } else {
                ...
                if (settings.requireExactQuery) {
                    if (!keywords.match(/(사서함|[동리가로길])\s*([0-9]+)(-[0-9]+)?(번지?)?($|,|\s)/) &&
                        ...
                        if (settings.useAlert) {
                            window.alert(info.translations[settings.language].errorExactQuery);
                        } else {
                ...
                ajaxSuccess = function(data, textStatus, jqXHR) {
                    ...
                    // 무료 API 서버의 일일 검색 허용 횟수를 초과한 경우...
                        ...
                        if (settings.useAlert) {
                            window.alert(info.translations[settings.language].errorQuota);
                        } else {
                    ...
                    // 그 밖의 에러 발생시...
                        ...
                        if (settings.useAlert) {
                            window.alert(info.translations[settings.language].errorError);
                        } else {
                    ...
                    // 정상 처리되었지만 검색 결과가 없는 경우...
                        ...
                        if (settings.useAlert) {
                            window.alert(info.translations[settings.language].errorEmpty);
                        } else {
                    ...
                    // 정상 처리되었지만 검색 서버의 버전이 맞지 않는 경우...
                        ...
                        if (settings.useAlert) {
                            window.alert(info.translations[settings.language].errorVersion);
                        } else {
                            err = $('<div class="error"></div>').postcodifyAddClass("search_status");
                    ...
                    // 검색 결과가 있는 경우...
                        ...
                        if (data.count >= 100) {
                            if (settings.useAlert) {
                                window.alert(info.translations[resultLanguage].errorTooMany);
                            } else {
